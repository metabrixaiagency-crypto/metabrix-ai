...
export const metadata: Metadata = {
  title: "Our Work | Premium Next.js & AI Web Case Studies",
  description: "Explore our selected works. A curated showcase of custom-coded business websites, AI support agents, and headless commerce platforms designed by Metabrix AI.",
};

export default function PortfolioPage() {
  return (
    <div className="flex-grow bg-brand-dark flex flex-col pt-16">
      {/* Hero Section */}
      ...
      {/* Interactive Showcase Grid Component */}
      <PortfolioShowcase />
    </div>
  );
}
