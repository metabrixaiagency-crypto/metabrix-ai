        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 pb-16 border-b border-white/5">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-xs text-muted-foreground/80 leading-relaxed max-w-xs uppercase tracking-wider font-light">
              Bespoke digital design and high-end Web engineering. We shape the digital frontier for forward-thinking premium brands.
            </p>
            {/* Social Links */}
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="h-8 w-8 rounded-full bg-white/5 border border-white/5 flex items-center justify-center text-muted-foreground hover:text-brand-gold hover:border-brand-gold/30 hover:bg-brand-gold-muted/10 transition-all duration-300"
                aria-label="Twitter"
              >
